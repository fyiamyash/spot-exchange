...
export const BuySell = () => {
  ...
  return (
    <div className="flex flex-col justify-center gap-2.5">
      ...
      <div className="w-full border border-neutral-200 rounded-2xl px-4 py-3">
      ...
      <div className="w-full border border-neutral-200 rounded-2xl px-4 py-4 flex justify-between items-center">
